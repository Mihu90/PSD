...
\end{figure}
\noindent{\rule{8cm}{0.4pt}}\\[0.0cm]
\textsc{\Large Universitatea Politehnica București\\Facultatea de Automatică și Calculatoare}\\[3.5cm]

{\Huge Politica de securitate}\\[0.3cm]
\textsc{\Large a platformei de forumuri\\ MyBB}\\[3.0cm]
...
\input{chapters/improvements.tex}
